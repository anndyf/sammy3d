...
export default function ComingSoonPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-10 bg-white border border-gray-200 rounded-[3rem] shadow-2xl relative overflow-hidden">
       ...
       <p className="text-gray-600 max-w-md mx-auto font-bold text-sm leading-relaxed mb-10">
       ...
       <button className="bg-white text-black px-10 py-4 rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] shadow-2xl hover:bg-blue-600 hover:scale-105 transition-all flex items-center gap-3 active:scale-95">
       ...
       <div className="mt-12 flex items-center gap-4 opacity-20 grayscale">
          <span className="text-[10px] font-black uppercase tracking-widest text-gray-600">Sammy 3D Labs</span>
       </div>
    </div>
  );
}
