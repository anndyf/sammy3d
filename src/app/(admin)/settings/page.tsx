    ...
    <div className="space-y-8 pb-20 select-none animate-in fade-in duration-500">
      ...
      {toast && (
        <div className={`fixed bottom-6 right-6 z-50 p-4 rounded-xl shadow-2xl border flex items-center gap-3 animate-in slide-in-from-bottom duration-300 ${
          ...
          <button onClick={() => setToast(null)} className="ml-3 text-gray-600 hover:text-white font-bold text-xs uppercase">Fechar</button>
        </div>
      )}
      ...
      <div className="flex flex-col gap-6 mb-8 mt-2">
         ...
         <div className="flex items-center gap-6 border-b border-gray-200 pb-0">
            ...
            <button 
              ...
              className={`pb-3 text-sm font-bold transition-all relative flex items-center gap-2 ${activeTab === 'fiscal' ? 'text-blue-600' : 'text-gray-500 hover:text-white'}`}
            >
            ...
            <button 
              ...
              className={`pb-3 text-sm font-bold transition-all relative flex items-center gap-2 ${activeTab === 'integracoes' ? 'text-[#FF4500]' : 'text-gray-500 hover:text-white'}`}
            >
        ...
        <div className="max-w-4xl space-y-6">
                ...
                <div className="flex flex-col items-center gap-3">
                   <div className="w-40 h-40 bg-gray-50 border border-gray-200 rounded-2xl flex items-center justify-center cursor-pointer hover:border-blue-600/50 transition-colors group overflow-hidden relative">
                      ...
                      <div className="relative w-24 h-24 flex flex-col items-center justify-center group-hover:scale-105 transition-transform duration-500">
                         ...
                         <div className="absolute -top-2 -right-2 w-8 h-8 bg-blue-600 rotate-[15deg] rounded-sm"></div>
                         <div className="w-full h-full bg-blue-600 rounded-2xl relative z-10 flex flex-col items-center justify-center border-4 border-black/10">
                   ...
                   <span className="text-[10px] font-medium text-gray-600">Clique para alterar (Max 2MB)</span>
                </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-lg">
             ...
             <div className="space-y-4">
                ...
                <div>
                   <label className="text-[11px] font-bold text-gray-500 uppercase tracking-widest block mb-1.5">Termos e Condições (Rodapé do PDF)</label>
                   <textarea 
                     rows={3} 
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-lg relative overflow-hidden">
             ...
             {shopId ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 border border-gray-200 rounded-2xl p-5">
                   ...
                   <div>
                      <div className="text-[10px] font-bold text-gray-600 uppercase tracking-widest mb-1">Modo de Operação</div>
             ...
             {loadingConfigs ? (
                ...
                <form onSubmit={handleSaveShopeeConfigs} className="space-y-6">
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                         <label className="text-[11px] font-bold text-gray-500 uppercase tracking-widest block mb-1.5">Partner ID (ID do Parceiro)</label>
                         <input 
                           type="text" 
                           value={partnerId}
                      ...
                      <div>
                         <label className="text-[11px] font-bold text-gray-500 uppercase tracking-widest block mb-1.5">Partner Key (Chave do Parceiro)</label>
                         <input 
                           type="password" 
                           value={partnerKey}
                   ...
                   <div className="flex items-center justify-between border-t border-gray-200 pt-6">
                      <div className="flex items-center gap-3">
                         ...
                         <div>
                            ...
                            <span className="text-[10px] text-gray-600 font-bold block">Desative para conectar com a loja real de produção.</span>
                         </div>
                      </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-lg">
             ...
             <div className="flex items-center gap-3 bg-gray-50 border border-gray-200 rounded-xl p-3">
                ...
                <button 
                  ...
                  className="bg-slate-800 hover:bg-slate-700 text-gray-500 hover:text-white px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-wider transition-all flex items-center gap-1.5 active:scale-95"
                >
                   {copied ? (
                     <>
