...
export default function PublicQuoteRequestPage() {
  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-black flex items-center justify-center p-6 selection:bg-[#00D1FF] selection:text-black">
        <div className="max-w-md w-full bg-[#111111] border border-gray-200 rounded-3xl p-8 text-center animate-in fade-in zoom-in duration-300 shadow-[0_0_50px_rgba(0,209,255,0.1)]">
  ...
  return (
    <div className="min-h-screen bg-black text-white pb-24 selection:bg-[#00D1FF] selection:text-black">
      ...
      {/* HEADER NAV */}
      <div className="h-24 px-6 md:px-10 flex items-center justify-between max-w-[1200px] mx-auto border-b border-gray-200">
         <Link href="/store" className="flex items-center gap-3 group">
            <div className="w-10 h-10 bg-white/5 rounded-xl border border-gray-200 flex items-center justify-center group-hover:bg-[#00D1FF] transition-all overflow-hidden p-1.5">
         ...
         <Link href="/store" className="px-4 py-2 text-[10px] font-black uppercase tracking-widest text-gray-500 hover:text-white border border-gray-200 rounded-full hover:bg-white/5 transition-all">
            Voltar
         </Link>
      </div>
      ...
      <div className="max-w-[800px] mx-auto px-6 pt-16">
        ...
        <div className="bg-[#111111] rounded-[40px] shadow-[0_0_50px_rgba(0,0,0,0.5)] border border-gray-200 overflow-hidden relative">
          <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[#00D1FF]/5 blur-[100px] mix-blend-screen pointer-events-none" />
          
          <div className="bg-white/5 px-8 py-5 border-b border-gray-200 flex items-center justify-between relative z-10">
          ...
          <form onSubmit={handleSubmit} className="p-8 md:p-12 space-y-10 relative z-10">
            ...
            <div className="space-y-6">
               <h4 className="flex items-center gap-3 text-[11px] font-black text-white uppercase tracking-[0.3em] pb-3 border-b border-gray-200">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 <div className="space-y-2">
                   ...
                   <input required type="text" placeholder="Ex: John Doe" className="w-full px-5 py-4 bg-black/50 border border-gray-200 rounded-2xl focus:bg-black focus:border-[#00D1FF] outline-none transition-all text-[14px] text-gray-900 placeholder-gray-400 font-medium placeholder:text-slate-700" value={formData.clientName} onChange={e => setFormData({...formData, clientName: e.target.value})} />
                 </div>
                 <div className="space-y-2">
                   <label className="text-[10px] font-black text-gray-600 uppercase tracking-widest pl-1">WhatsApp de Contato</label>
                   <input required type="text" placeholder="(00) 90000-0000" maxLength={15} className="w-full px-5 py-4 bg-black/50 border border-gray-200 rounded-2xl focus:bg-black focus:border-[#00D1FF] outline-none transition-all text-[14px] text-gray-900 placeholder-gray-400 font-medium placeholder:text-slate-700" value={formData.clientContact} onChange={handlePhoneChange} />
                 </div>
               </div>
            </div>
            ...
            {/* DADOS DO PROJETO */}
            <div className="space-y-6">
               <h4 className="flex items-center gap-3 text-[11px] font-black text-white uppercase tracking-[0.3em] pb-3 border-b border-gray-200 pt-4">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 <div className="space-y-2">
                   ...
                   <input required type="text" placeholder="Ex: Suporte para Headset" className="w-full px-5 py-4 bg-black/50 border border-gray-200 rounded-2xl focus:bg-black focus:border-[#00D1FF] outline-none transition-all text-[14px] text-gray-900 placeholder-gray-400 font-medium placeholder:text-slate-700" value={formData.projectName} onChange={e => setFormData({...formData, projectName: e.target.value})} />
                 </div>
                 <div className="space-y-2">
                   <label className="text-[10px] font-black text-gray-600 uppercase tracking-widest pl-1">Finalidade Industrial</label>
                   <select required className="w-full px-5 py-4 bg-black/50 border border-gray-200 rounded-2xl focus:bg-black focus:border-[#00D1FF] outline-none transition-all text-[13px] text-gray-900 font-bold cursor-pointer appearance-none" value={formData.purpose} onChange={e => setFormData({...formData, purpose: e.target.value})}>
               ...
               <div className="bg-white/5 border border-gray-200 rounded-3xl p-6 space-y-8">
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div className="space-y-1.5 flex flex-col">
                          ...
                          <input type="text" placeholder="Ex: 10" className="w-full px-4 py-3 bg-black/40 border border-gray-200 rounded-xl text-center focus:bg-black focus:border-[#00D1FF] outline-none transition-all font-mono text-gray-900 placeholder-gray-400" value={formData.height} onChange={e=>setFormData({...formData, height: e.target.value})} />
                      </div>
                      <div className="space-y-1.5 flex flex-col">
                          <span className="text-[9px] font-black uppercase text-gray-600 pl-1">X (Larg.)</span>
                          <input type="text" placeholder="Ex: 5" className="w-full px-4 py-3 bg-black/40 border border-gray-200 rounded-xl text-center focus:bg-black focus:border-[#00D1FF] outline-none transition-all font-mono text-gray-900 placeholder-gray-400" value={formData.width} onChange={e=>setFormData({...formData, width: e.target.value})} />
                      </div>
                      <div className="space-y-1.5 flex flex-col">
                          <span className="text-[9px] font-black uppercase text-gray-600 pl-1">Y (Prof.)</span>
                          <input type="text" placeholder="Ex: 5" className="w-full px-4 py-3 bg-black/40 border border-gray-200 rounded-xl text-center focus:bg-black focus:border-[#00D1FF] outline-none transition-all font-mono text-gray-900 placeholder-gray-400" value={formData.length} onChange={e=>setFormData({...formData, length: e.target.value})} />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <select required className="w-full px-5 py-4 bg-black/40 border border-gray-200 rounded-xl focus:bg-black focus:border-[#00D1FF] outline-none transition-all text-sm cursor-pointer text-gray-900 font-bold appearance-none bg-[url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%22292.4%22%20height%3D%22292.4%22%3E%3Cpath%20fill%3D%22%23FFFFFF%22%20d%3D%22M287%2069.4a17.6%2017.6%200%200%200-13-5.4H18.4c-5%200-9.3%201.8-12.9%205.4A17.6%2017.6%200%200%200%200%2082.2c0%205%201.8%209.3%205.4%2012.9l128%20127.9c3.6%203.6%207.8%205.4%2012.8%205.4s9.2-1.8%2012.8-5.4L287%2095c3.5-3.5%205.4-7.8%205.4-12.8%200-5-1.9-9.2-5.5-12.8z%22%2F%3E%3C%2Fsvg%3E')] bg-no-repeat bg-[right_1rem_center] bg-[length:12px]" value={formData.preferredColor} onChange={e => setFormData({...formData, preferredColor: e.target.value})}>
            ...
            <div className="space-y-6">
               ...
               <div className="space-y-4">
                 <div className="relative group">
                   ...
                   <label htmlFor="file-upload" className="flex flex-col items-center justify-center border-2 border-dashed border-gray-200 rounded-3xl p-10 bg-black/20 cursor-pointer group-hover:border-[#00D1FF] group-hover:bg-[#00D1FF]/5 transition-all group-active:scale-95 shadow-inner">
                     <div className="w-14 h-14 bg-white/5 border border-gray-200 rounded-2xl flex items-center justify-center mb-4 group-hover:bg-[#00D1FF] group-hover:text-white transition-all shadow-[0_0_20px_rgba(0,0,0,0.5)]">
                 ...
                 <div className="relative py-4 flex items-center justify-center">
                   <div className="absolute inset-0 flex items-center w-full"><div className="w-full border-t border-gray-200"></div></div>
                 ...
                 <input type="url" placeholder="Link (Thingiverse, Printables, Drive)" className="w-full px-5 py-4 bg-black/50 border border-gray-200 rounded-2xl focus:bg-black focus:border-[#00D1FF] outline-none transition-all text-sm font-medium text-gray-900 placeholder-gray-400 placeholder:text-slate-700" value={formData.externalLink} onChange={e => setFormData({...formData, externalLink: e.target.value})} />
               </div>
            </div>
            ...
            <div className="space-y-4 pt-4 border-t border-gray-200">
              ...
              <textarea rows={4} placeholder="Densidade de preenchimento, espessura de parede especial, acabamento pós-cura..." className="w-full px-5 py-5 bg-black/50 border border-gray-200 rounded-3xl focus:bg-black focus:border-[#00D1FF] outline-none transition-all resize-none text-[14px] font-medium text-white placeholder:text-slate-700" value={formData.description} onChange={e => setFormData({...formData, description: e.target.value})} />
            </div>

            <div className="pt-8 border-t border-gray-200">
              <button disabled={loading} type="submit" className="w-full h-16 bg-[#00D1FF] text-black font-black rounded-2xl flex items-center justify-center gap-3 hover:bg-white hover:text-white transition-all active:scale-[0.98] disabled:opacity-50 text-[13px] uppercase tracking-[0.2em] shadow-[0_0_30px_rgba(0,209,255,0.3)]">
